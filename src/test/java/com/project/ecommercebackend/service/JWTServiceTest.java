...
public class JWTServiceTest {
    ...
    @Test
    public void testVerificationNotUsableForLogin() {
        LocalUser user = localUserDAO.findByUsernameIgnoreCase("UserA").get();
        String token = jwtService.generateVerificationJWT(user);
        Assertions.assertNull(jwtService.getUsername(token), "Verification should not contain username.");
    ...
    @Test
    public void testLoginJWTNotCreateByUs() {
    ...
    @Test
    public void testResetPasswordJWTNotCreateByUs() {
    ...
    public void testPasswordResetToken() {
        ...
        Assertions.assertEquals(user.getEmail(), jwtService.getResetPasswordEmail(token), "Email should match inside " +
                "JWT.");
    }
